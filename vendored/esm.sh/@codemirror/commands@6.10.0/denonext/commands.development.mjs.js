...
import { Annotation, Facet, combineConfig, StateField, Transaction, ChangeSet, ChangeDesc, EditorSelection, StateEffect, Text, findClusterBreak, countColumn, CharCategory } from "../../state@^6.4.0.js";
import { EditorView, Direction } from "../../view@^6.27.0.js";
import { IndentContext, getIndentation, indentString, matchBrackets, syntaxTree, getIndentUnit, indentUnit } from "../../language@^6.0.0.js";
import { NodeProp } from "../../../@lezer/common@^1.1.0.js";
...
function pageInfo(view) {
  ...
  if (selfScroll) {
    ...
    height = (view.dom.ownerDocument.defaultView || globalThis).innerHeight;
  }
  return {
    marginTop,
    marginBottom,
...
//# sourceMappingURL=commands.development.mjs.map