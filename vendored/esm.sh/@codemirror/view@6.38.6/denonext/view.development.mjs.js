/* esm.sh - @codemirror/view@6.38.6 */
// node_modules/@codemirror/view/dist/index.js
import { Text, RangeSet, MapMode, RangeValue, findClusterBreak, EditorSelection, Facet, StateEffect, ChangeSet, findColumn, CharCategory, EditorState, Annotation, Transaction, Prec, codePointAt, codePointSize, combineConfig, StateField, RangeSetBuilder, countColumn } from "../../state@^6.5.0.js";
import { StyleModule } from "../../../style-mod@^4.1.0.js";
import { keyName, base, shift } from "../../../w3c-keyname@^2.2.4.js";
import elt from "../../../crelt@^1.0.6.js";
...
handlers.beforeinput = (view, event) => {
  ...
  if (browser.chrome && browser.android && (pending = PendingKeys.find((key) => key.inputType == event.inputType))) {
    ...
    if (pending.key == "Backspace" || pending.key == "Delete") {
      ...
      setTimeout(() => {
        var _a2;
        if ((((_a2 = globalThis.visualViewport) === null || _a2 === void 0 ? void 0 : _a2.height) || 0) > startViewHeight + 10 && view.hasFocus) {
...
function rectanglesForRange(view, className, range) {
  ...
  let lineElt = content.querySelector(".cm-line"), lineStyle = lineElt && globalThis.getComputedStyle(lineElt);
...
var Placeholder = class extends WidgetType {
  ...
  coordsAt(dom) {
    ...
    if (!rects.length)
      return null;
    let style = globalThis.getComputedStyle(dom.parentNode);
...
//# sourceMappingURL=view.development.mjs.map