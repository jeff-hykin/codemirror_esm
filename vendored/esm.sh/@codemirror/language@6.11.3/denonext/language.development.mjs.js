...
import { NodeProp, IterMode, Tree, TreeFragment, Parser, NodeType, NodeSet } from "../../../@lezer/common@^1.1.0.js";
import { StateEffect, StateField, Facet, EditorState, countColumn, combineConfig, RangeSet, RangeSetBuilder, Prec } from "../../state@^6.0.0.js";
import { ViewPlugin, logException, EditorView, Decoration, WidgetType, gutter, GutterMarker, Direction } from "../../view@^6.23.0.js";
import { tags, tagHighlighter, highlightTree, styleTags } from "../../../@lezer/highlight@^1.0.0.js";
import { StyleModule } from "../../../style-mod@^4.0.0.js";
var _a;
...
var alwaysIsolate = /* @__PURE__ */ Facet.define({ combine: (values) => values.some((x) => x) });
...
//# sourceMappingURL=language.development.mjs.map