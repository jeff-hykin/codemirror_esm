/* esm.sh - @codemirror/merge@6.11.1 */
// node_modules/@codemirror/merge/dist/index.js
import { EditorView, ViewPlugin, gutter, Decoration, GutterMarker, WidgetType } from "../../view@^6.17.0.js";
import { Facet, StateEffect, StateField, EditorSelection, Prec, RangeSet, RangeSetBuilder, Compartment, EditorState, ChangeSet, Text } from "../../state@^6.0.0.js";
import { StyleModule } from "../../../style-mod@^4.1.0.js";
import { language, highlightingFor } from "../../language@^6.0.0.js";
import { highlightTree } from "../../../@lezer/highlight@^1.0.0.js";
...
var goToNextChunk = /* @__PURE__ */ moveByChunk(1);
var goToPreviousChunk = /* @__PURE__ */ moveByChunk(-1);
...
var MergeView = class {
  ...
  */
  ...
  scheduleMeasure() {
    if (this.measuring < 0) {
      let win = this.dom.ownerDocument.defaultView || globalThis;
  ...
  */
  destroy() {
    ...
    this.b.destroy();
    if (this.measuring > -1)
      (this.dom.ownerDocument.defaultView || globalThis).cancelAnimationFrame(this.measuring);
    this.dom.remove();
  }
};
function rm(elt) {
...
var deletedChunkGutterMarker = /* @__PURE__ */ new class extends GutterMarker {
  constructor() {
    super(...arguments);
    this.elementClass = "cm-deletedLineGutter";
  }
}();
var unifiedChangeGutter = /* @__PURE__ */ Prec.low(/* @__PURE__ */ gutter({
  class: "cm-changeGutter",
  markers: (view) => {
    var _a;
    return ((_a = view.plugin(decorateChunks)) === null || _a === void 0 ? void 0 : _a.gutter) || RangeSet.empty;
...
var deletedChunks = /* @__PURE__ */ StateField.define({
  ...
  abort: if (linesA == linesB && linesA < 10) {
    ...
    for (let ch of chunk.changes) {
      if (ch.fromA < ch.toA) {
        ...
        if (/\n/.test(deleted2))
          break abort;
        deco.push(Decoration.widget({ widget: new InlineDeletion(deleted2), side: -1 }).range(bB + ch.fromB));
      }
      if (ch.fromB < ch.toB) {
...
var inlineChangedLineGutterMarker = /* @__PURE__ */ new class extends GutterMarker {
  constructor() {
    super(...arguments);
    this.elementClass = "cm-inlineChangedLineGutter";
  }
}();
var inlineChangedLine = /* @__PURE__ */ Decoration.line({ class: "cm-inlineChangedLine" });
...
//# sourceMappingURL=merge.development.mjs.map