/* esm.sh - @codemirror/lang-jinja@6.0.0 */
// node_modules/@codemirror/lang-jinja/dist/index.js
import { syntaxTree, LRLanguage, indentNodeProp, delimitedIndent, foldNodeProp, LanguageSupport } from "../../language@^6.0.0.js";
import { html } from "../../lang-html@^6.0.0.js";
import { styleTags, tags } from "../../../@lezer/highlight@^1.2.0.js";
import { parseMixed } from "../../../@lezer/common@^1.2.0.js";
import { ExternalTokenizer, LRParser, LocalTokenGroup } from "../../../@lezer/lr@^1.4.0.js";
...
var base = /* @__PURE__ */ new ExternalTokenizer((input) => {
  let start = input.pos;
  for (; ; ) {
    let { next } = input;
    if (next < 0)
...
var raw = /* @__PURE__ */ rawTokenizer("endraw", rawText, endrawTagStart);
...
var parser = /* @__PURE__ */ LRParser.deserialize({
  ...
  tokenizers: [base, raw, 1, 2, 3, 4, 5, /* @__PURE__ */ new LocalTokenGroup("b~RPstU~XP#q#r[~aO$Q~~", 17, 173)],
...
var Functions = /* @__PURE__ */ completions("boolean callable defined divisibleby eq escaped even filter float ge gt in integer iterable le lower lt mapping ne none number odd sameas sequence string test undefined upper range lipsum dict joiner namespace", "function");
var Globals = /* @__PURE__ */ completions("loop super self true false varargs kwargs caller name arguments catch_kwargs catch_varargs caller", "keyword");
var Expressions = /* @__PURE__ */ Functions.concat(Globals);
var Tags = /* @__PURE__ */ completions("raw endraw filter endfilter trans pluralize endtrans with endwith autoescape endautoescape if elif else endif for endfor call endcall block endblock set endset macro endmacro import include break continue debug do extends", "keyword");
...
var closePercentBrace = /* @__PURE__ */ EditorView.inputHandler.of((view, from, to, text2) => {
...
var tagLanguage = /* @__PURE__ */ LRLanguage.define({
  name: "jinja",
  parser: /* @__PURE__ */ parser.configure({
    props: [
      /* @__PURE__ */ styleTags({
        ...
        "self": tags.self,
        "loop super": /* @__PURE__ */ tags.standard(tags.variableName),
        ...
        "FilterName": /* @__PURE__ */ tags.special(tags.variableName),
      ...
      /* @__PURE__ */ indentNodeProp.add({
        ...
        "IfStatement ForStatement": /* @__PURE__ */ statementIndent(/^\s*(\{%-?\s*)?(endif|endfor|else|elif)\b/),
        "Statement": /* @__PURE__ */ statementIndent(/^\s*(\{%-?\s*)?end\w/)
      }),
...
var jinjaLanguage = /* @__PURE__ */ makeJinja(baseHTML.language);
...
//# sourceMappingURL=lang-jinja.development.mjs.map