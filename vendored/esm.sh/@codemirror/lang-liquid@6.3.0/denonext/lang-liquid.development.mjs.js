/* esm.sh - @codemirror/lang-liquid@6.3.0 */
...
import { parseMixed } from "../../../@lezer/common@^1.0.0.js";
import { ExternalTokenizer, LRParser } from "../../../@lezer/lr@^1.3.1.js";
import { EditorSelection } from "../../state@^6.0.0.js";
import { EditorView } from "../../view@^6.0.0.js";
...
var comment = /* @__PURE__ */ rawTokenizer("endcomment", commentText, endcommentTagStart);
var raw = /* @__PURE__ */ rawTokenizer("endraw", rawText, endrawTagStart);
var inlineComment = /* @__PURE__ */ new ExternalTokenizer((input) => {
  if (input.next != 35)
    return;
  input.advance();
  for (; ; ) {
...
var Tags = /* @__PURE__ */ completions("cycle comment endcomment raw endraw echo increment decrement liquid if elsif else endif unless endunless case endcase for endfor tablerow endtablerow break continue assign capture endcapture render include", "keyword");
var Expressions = /* @__PURE__ */ completions("empty forloop tablerowloop in with as", "keyword");
var forloop = /* @__PURE__ */ completions("first index index0 last length rindex", "property");
var tablerowloop = /* @__PURE__ */ completions("col col0 col_first col_last first index index0 last length rindex rindex0 row", "property");
...
var liquidLanguage = /* @__PURE__ */ makeLiquid(baseHTML.language);
...
//# sourceMappingURL=lang-liquid.development.mjs.map