/* esm.sh - @codemirror/lang-angular@0.1.4 */
// node_modules/@codemirror/lang-angular/dist/index.js
import { LRLanguage, LanguageSupport } from "../../language@^6.0.0.js";
import { html } from "../../lang-html@^6.0.0.js";
import { javascriptLanguage } from "../../lang-javascript@^6.1.2.js";
import { styleTags, tags } from "../../../@lezer/highlight@^1.0.0.js";
import { parseMixed } from "../../../@lezer/common@^1.2.0.js";
import { ExternalTokenizer, LRParser } from "../../../@lezer/lr@^1.3.3.js";
var Text = 1;
...
var exprParser = /* @__PURE__ */ javascriptLanguage.parser.configure({
...
var baseHTML = /* @__PURE__ */ html({ selfClosingTags: true });
function mkAngular(language) {
  return language.configure({ wrap: parseMixed(mixAngular) }, "angular");
}
var angularLanguage = /* @__PURE__ */ mkAngular(baseHTML.language);
...
//# sourceMappingURL=lang-angular.development.mjs.map