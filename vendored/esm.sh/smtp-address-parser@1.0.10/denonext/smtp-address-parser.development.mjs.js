/* esm.sh - smtp-address-parser@1.0.10 */
import*as __0$ from"../../nearley@^2.20.1.js";var require=n=>{const e=m=>typeof m.default<"u"?m.default:m,c=m=>Object.assign({__esModule:true},m);switch(n){case"nearley":return e(__0$);default:console.error('module "'+n+'" not found');return null;}};
...
var require_lib = __commonJS({
  "node_modules/smtp-address-parser/dist/lib/index.js"(exports) {
    ...
    function normalize_dot_string2(dot_string) {
    ...
    exports.normalize_dot_string = normalize_dot_string2;
    function normalize2(address) {
      var _a, _b;
      const a = parse2(address);
      const domain = (_a = a.domainPart.AddressLiteral) !== null && _a !== void 0 ? _a : a.domainPart.DomainName.toLowerCase();
      const local = (_b = a.localPart.QuotedString) !== null && _b !== void 0 ? _b : normalize_dot_string2(a.localPart.DotString);
      return `${local}@${domain}`;
    }
    exports.normalize = normalize2;
    function canonicalize_quoted_string2(quoted_string) {
    ...
    exports.canonicalize_quoted_string = canonicalize_quoted_string2;
    function canonicalize2(address) {
      var _a;
      const a = parse2(address);
      const domain = (_a = a.domainPart.AddressLiteral) !== null && _a !== void 0 ? _a : a.domainPart.DomainName.toLowerCase();
      const local = a.localPart.QuotedString ? canonicalize_quoted_string2(a.localPart.QuotedString) : a.localPart.DotString;
      return `${local}@${domain}`;
    }
...
var { __esModule, canonicalize, canonicalize_quoted_string, normalize, normalize_dot_string, parse } = cjsm;
...
//# sourceMappingURL=smtp-address-parser.development.mjs.map