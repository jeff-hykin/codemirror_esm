/* esm.sh - @replit/codemirror-lang-svelte@6.0.0 */
// node_modules/@replit/codemirror-lang-svelte/dist/index.js
import { ContextTracker, ExternalTokenizer, LRParser } from "../../../@lezer/lr@^1.0.0.js";
import { styleTags, tags } from "../../../@lezer/highlight@^1.0.0.js";
import { LRLanguage, indentNodeProp, foldNodeProp, syntaxTree, LanguageSupport } from "../../../@codemirror/language@^6.0.0.js";
import { cssLanguage, css } from "../../../@codemirror/lang-css@^6.0.1.js";
import { typescriptLanguage, javascriptLanguage, javascript } from "../../../@codemirror/lang-javascript@^6.1.1.js";
import { parseMixed } from "../../../@lezer/common@^1.0.0.js";
import { parser as parser$1 } from "../../../@lezer/javascript@^1.2.0.js";
import { htmlCompletionSource } from "../../../@codemirror/lang-html@^6.2.0.js";
import { EditorView } from "../../../@codemirror/view@^6.0.0.js";
import { EditorSelection } from "../../../@codemirror/state@^6.0.0.js";
var scriptText = 145;
var StartCloseScriptTag = 1;
var styleText = 146;
var StartCloseStyleTag = 2;
var textareaText = 147;
...
var tagStart = /* @__PURE__ */ new ExternalTokenizer(
  (input, stack) => {
...
var textareaTokens = /* @__PURE__ */ contentTokenizer(
  "textarea",
  textareaText,
...
var asterisk = 42;
var tick = 96;
var prefixes = [colon, hash, at, slash];
var commentContent = /* @__PURE__ */ new ExternalTokenizer((input) => {
...
var spec_identifier = { __proto__: null, if: 54, as: 66, then: 84, catch: 86 };
...
var spec_TagName = { __proto__: null, svelte: 243 };
...
var defaultNesting = [
  ...
  },
  {
    tag: "style",
    attrs(attrs) {
      return (!attrs.lang || attrs.lang === "css" || attrs.lang === "scss") && (!attrs.type || /^(text\/)?(x-)?(stylesheet|css|scss)$/i.test(attrs.type));
    },
      ...
      /* @__PURE__ */ indentNodeProp.add({
        ...
        "Block": (context) => {
          ...
          if (text.startsWith("{/")) {
            ...
            if (name === "IfBlock" && text.startsWith("{/if") || name === "EachBlock" && text.startsWith("{/each") || name === "AwaitBlock" && text.startsWith("{/await") || name === "KeyBlock" && text.startsWith("{/key")) {
...
var autoCloseTags = /* @__PURE__ */ EditorView.inputHandler.of((view, from, to, text) => {
  if (view.composing || view.state.readOnly || from != to || text != ">" && text != "/" || !svelteLanguage.isActiveAt(view.state, from, -1))
    return false;
  let { state } = view;
...
//# sourceMappingURL=codemirror-lang-svelte.development.mjs.map